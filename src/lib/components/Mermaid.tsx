      ...
      if (svgElement) {
        ...
        svgElement.querySelectorAll('rect').forEach((el) => {
          ...
          if (isCluster) {
            ...
            (svgEl as unknown as HTMLElement).style.cssText = `fill: ${clusterFill} !important; stroke: ${strokeColor} !important; stroke-width: 2px !important; stroke-dasharray: 5 5 !important;`;
          } else {
            // Regular boxes - force the fill
            svgEl.setAttribute('fill', fillColor);
            svgEl.setAttribute('stroke', strokeColor);
            svgEl.setAttribute('stroke-width', '2');
            (svgEl as unknown as HTMLElement).style.cssText = `fill: ${fillColor} !important; stroke: ${strokeColor} !important; stroke-width: 2px !important;`;
          }
        });
        ...
        svgElement.querySelectorAll('path, line, polyline').forEach((el) => {
          ...
          svgEl.setAttribute('stroke', strokeColor);
          svgEl.setAttribute('stroke-width', '2');
          (svgEl as unknown as HTMLElement).style.cssText = `stroke: ${strokeColor} !important; stroke-width: 2px !important; fill: none !important;`;
        });
        ...
        svgElement.querySelectorAll('text, tspan, .nodeLabel, .edgeLabel').forEach((el) => {
          ...
          (svgEl as unknown as HTMLElement).style.cssText = `fill: ${textColor} !important; color: ${textColor} !important;`;
        });
        ...
        svgElement.querySelectorAll('marker path, marker polygon').forEach((el) => {
          ...
          svgEl.setAttribute('stroke', strokeColor);
          (svgEl as unknown as HTMLElement).style.cssText = `fill: ${strokeColor} !important; stroke: ${strokeColor} !important;`;
        });
      }
    }
