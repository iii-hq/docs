...
The included `docker-compose.prod.yml` adds a [Caddy](https://caddyserver.com/docs/) reverse proxy for TLS, password-protected Redis, and container resource limits.
...
Example configuration with all common modules:
