...
> **See Examples**: For practical examples of multi-trigger steps and conditions in action, see [Motia SDK - Multiple Triggers](/quickstart/motia-sdk#multiple-triggers) and [Trigger Conditions](/quickstart/motia-sdk#trigger-conditions).
...
<Columns cols={2}>
  <Card icon={<Code />} title="Motia Framework" href="/quickstart/motia-framework">
    Learn about the high-level Python framework
  </Card>
  <Card icon={<Zap />} title="Remote Functions" href="/remote-functions">
