...
| `registerservice` | Registers a service namespace | `id`, `description` |
...
- `IIIError::InvocationFailed` — remote function returned an error
- `IIIError::Serialization` — JSON serialization failed
