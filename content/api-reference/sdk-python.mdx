...
<ResponseField name="register_service" type="(id: str, description: str | None = None, parent_id: str | None = None) => None" required>
  Registers a service namespace that groups related functions.
</ResponseField>

### call

<ResponseField name="call" type="async (path: str, data: Any, timeout: float = 30.0) => Any" required>
  ...
  <AccordionGroup>
    ...
    <Accordion iconName="Code" title="Example" description="">
      ```python
      result = await iii.call("queue::enqueue", {
          "topic": "user.created",
          "data": {"user_id": "123"},
      })
      ```
...
<ResponseField name="call_void" type="(path: str, data: Any) => None" required>
