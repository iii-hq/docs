...
- **[API](/docs/core-modules-list/module-rest-api)**: HTTP requests
- **[Event](/docs/core-modules-list/module-event)**: Published events on topics
- **[Cron](/docs/core-modules-list/module-cron)**: Scheduled time-based execution
- **[Log](/docs/core-modules-list/module-logging)**: System log events
- **[Streams](/docs/core-modules-list/module-stream)**: Stream connection lifecycle (join/leave)
...
**Provided by**: [REST API Module](/docs/core-modules-list/module-rest-api)
...
<Card icon="Globe" title="REST API Module" href="/docs/core-modules-list/module-rest-api">
...
**Provided by**: [Event Module](/docs/core-modules-list/module-event)
...
<Card icon="Zap" title="Event Module" href="/docs/core-modules-list/module-event">
...
**Provided by**: [Cron Module](/docs/core-modules-list/module-cron)
...
<Card icon="Clock" title="Cron Module" href="/docs/core-modules-list/module-cron">
...
**Provided by**: [Logging Module](/docs/core-modules-list/module-logging)
...
<Card icon="FileText" title="Logging Module" href="/docs/core-modules-list/module-logging">
...
**Provided by**: [Stream Module](/docs/core-modules-list/module-stream)
...
<Card icon="Activity" title="Stream Module" href="/docs/core-modules-list/module-stream">
