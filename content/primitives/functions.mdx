...
The context object is how you access the full application functionality such as state, logging, databasing, invoking triggers. If the iii engine has access to it then the context object will contain it.
