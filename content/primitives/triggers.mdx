---
title: 'Triggers'
description: 'Triggers are the entrypoint of a iii-powered application.'
---
...
From the application developer standpoint it functions something like this. Although there are a few more layers inbetween and Functions are a more abstract primitive within iii.
