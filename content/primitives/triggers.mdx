...
From the application developer standpoint, it functions something like this. There are a few more layers in between, and Functions are a more abstract primitive within iii.
