...
const user = await iii.call('kv_server::get', {
  index: 'default',
  key: 'user:123',
})
...
```typescript
await iii.call('kv_server::set', { index: 'default', key: 'user:1', value: { name: 'Alice' } })
await iii.call('kv_server::set', { index: 'default', key: 'user:2', value: { name: 'Bob' } })
await iii.call('kv_server::set', { index: 'default', key: 'product:1', value: { name: 'Widget' } })

const userKeys = await iii.call('kv_server::list_keys_with_prefix', {
  prefix: 'user:',
})
```
