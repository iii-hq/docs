...
- **[API](/modules/module-rest-api)**: HTTP requests
- **[Event](/modules/module-event)**: Published events on topics
- **[Cron](/modules/module-cron)**: Scheduled time-based execution
- **[Log](/modules/module-logging)**: System log events
- **[Streams](/modules/module-stream)**: Stream connection lifecycle (join/leave)
...
**Provided by**: [REST API Module](/modules/module-rest-api)
...
<Card icon={<Globe />} title="REST API Module" href="/modules/module-rest-api">
...
**Provided by**: [Event Module](/modules/module-event)
...
<Card icon={<Zap />} title="Event Module" href="/modules/module-event">
...
<Card icon={<Clock />} title="Cron Module" href="/modules/module-cron">
...
**Provided by**: [Logging Module](/modules/module-logging)
...
<Card icon={<FileText />} title="Logging Module" href="/modules/module-logging">
...
<Card icon={<Activity />} title="Stream Module" href="/modules/module-stream">
