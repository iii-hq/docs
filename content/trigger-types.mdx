...
- **[API](/core-modules-list/module-rest-api)**: HTTP requests
- **[Event](/core-modules-list/module-event)**: Published events on topics
- **[Cron](/core-modules-list/module-cron)**: Scheduled time-based execution
- **[Log](/core-modules-list/module-logging)**: System log events
- **[Streams](/core-modules-list/module-stream)**: Stream connection lifecycle (join/leave)
...
**Provided by**: [REST API Module](/core-modules-list/module-rest-api)
...
<Card icon="Globe" title="REST API Module" href="/core-modules-list/module-rest-api">
...
**Provided by**: [Event Module](/core-modules-list/module-event)
...
<Card icon="Zap" title="Event Module" href="/core-modules-list/module-event">
...
**Provided by**: [Cron Module](/core-modules-list/module-cron)
...
<Card icon="Clock" title="Cron Module" href="/core-modules-list/module-cron">
...
**Provided by**: [Logging Module](/core-modules-list/module-logging)
...
<Card icon="FileText" title="Logging Module" href="/core-modules-list/module-logging">
...
**Provided by**: [Stream Module](/core-modules-list/module-stream)
...
<Card icon="Activity" title="Stream Module" href="/core-modules-list/module-stream">
...
<Columns cols={2}>
  <Card icon="Recycle" title="Triggers" href="/triggers">
    Learn how to register and configure triggers
  </Card>
  <Card icon="Blocks" title="Core Modules" href="/core-modules">
