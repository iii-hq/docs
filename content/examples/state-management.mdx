...
|---|---|---|---|
| Write | `await iii.trigger('state::set', { scope, key, data })` | `await iii.trigger("state::set", {...})` | `iii.trigger_void("state::set", json!({...}))` |
...
| Delete | `await iii.trigger('state::delete', { scope, key })` | `await iii.trigger("state::delete", {...})` | `iii.trigger_void("state::delete", json!({...}))` |
