...
|---|---|---|---|
| Write | `iii.trigger('state::set', { scope, key, data })` | `await iii.trigger("state::set", {...})` | `iii.trigger_void("state::set", json!({...}))` |
| Read one | `iii.trigger('state::get', { scope, key })` | `await iii.trigger("state::get", {...})` | `iii.trigger("state::get", json!({...})).await` |
| Read all in scope | `iii.trigger('state::list', { scope })` | `await iii.trigger("state::list", {...})` | `iii.trigger("state::list", json!({...})).await` |
| Delete | `iii.trigger('state::delete', { scope, key })` | `await iii.trigger("state::delete", {...})` | `iii.trigger_void("state::delete", json!({...}))` |
