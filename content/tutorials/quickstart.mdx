...
<Cards>
  <Card icon={<LayoutTemplate />} title="Concepts" href={`/docs/concepts`}>
    Understand how Function and Trigger work under the hood.
  </Card>
  <Card icon={<Settings />} title="How-to Guides" href={`/docs/how-to/expose-http-endpoint`}>
    Solve specific problems: HTTP endpoints, background jobs, state, and more.
  </Card>
  <Card icon={<Code />} title="Examples" href={`/docs/examples`}>
    Working examples: Hello World, state management, cron, observability, and more.
  </Card>
  <Card icon={<FileText />} title="SDK Reference" href={`/docs/api-reference/iii-sdk`}>
    Complete API reference for TypeScript, Python, and Rust.
  </Card>
</Cards>
