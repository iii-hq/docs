...
The README will explain what the project is doing and how quickly start up
the services that will connect to the iii engine and use it for their communication.

After succeeding with the project explore the `worker.ts` file from the project
