...
<AccordionGroup>
  ...
  <Accordion title="Function Organization">
    ...
    ```typescript
    bridge.registerFunction({ id: 'users::create', ... });
    bridge.registerFunction({ id: 'users::update', ... });
    bridge.registerFunction({ id: 'users::delete', ... });

    bridge.registerFunction({ id: 'auth::login', ... });
    bridge.registerFunction({ id: 'auth::logout', ... });
    ```
